...
Only `imputation-v3-smoke-evidence-v2` is accepted. Earlier v1 evidence is unsupported and must be regenerated by rerunning the bounded CPU smoke; it is never upgraded in place.
